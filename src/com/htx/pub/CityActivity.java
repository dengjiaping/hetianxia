...
public class CityActivity extends Activity {
	...
	// 市，自治区集合
	private int[] city = { R.array.shi, R.array.beijin_province_item,
	...
	private int[] county = { R.array.xian };
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		resetpwd.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				String st = Locationm.getDataGeocoding(CityActivity.this,
						strProvince + "省" + strCity + "市" + strCounty);
				Intent intent = new Intent(CityActivity.this,
						NearbySearchActivity.class);
				intent.putExtra("locat", st);
