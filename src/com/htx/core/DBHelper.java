...
public class DBHelper {
    ...
    public DBHelper(Context _context) {
    	...
    	try{
    		...
    		Log.w(Const.TAG, "DBHelper instance|error="+e);
    	}   
    }   
    ...
    private void createTable(){
        try {
            ...
            Log.w(Const.TAG, "DBHelper.initTable|error.");   
            e.printStackTrace();
        }   
    }   
...
//            
//        }catch(Exception e){
//            Log.w(Const.TAG,"DBHelper.saveUser|insert Table t_param err ,name="+name+",value="+newVersion);   
//            return false;   
//        }
//        
//    }
    ...
    public boolean saveUser(String type,String utoken,String tokensecret){
        ...
        try{   
            ...
            Log.w(Const.TAG,"DBHelper.saveUser|insert Table t_user err ,sql: "+sql);   
            return false;   
        }   
    }
    ...
    public boolean save(String pid,String name,int price,int shops,int reviews,String picurl){
        ...
        try{   
            ...
            Log.w(Const.TAG,"DBHelper.save|insert Table t_sc err ,sql: "+sql);   
            return false;   
        }   
    }
    ...
    public boolean delData(String pid) {
    	...
    	try{
            ...
            Log.w(Const.TAG,"DBHelper.delData|t_sc pid="+pid+",err:"+e);
        }
	    return res;
    }
    ...
    public boolean deleteAllData(String tableName){
    	try{
            ...
            Log.w(Const.TAG,"DBHelper.deleteAllData|t_sc err:"+e);
            return false;
        }
    }
...
//          cursor.close();
//  	} catch (Exception e) {
//  		Log.w(Const.TAG, "DBHelper.tabIsExist|error="+e);
